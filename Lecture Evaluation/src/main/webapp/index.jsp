...
%>
			...
			<form action="./index.jsp" method="get" class="form-inline my-2 my-lg-0">
				<input type="text" name="search" class="form-control my-sm-2" placeholder="내용을 입력하세요" aria-label="Search">
			...
			<div class="card-body">
				...
				<div class="row">
					...
					<div class="col-3 text-right">
						<a onclick="return confirm('추천하시겠습니까?')" href="./likeAction.jsp?evaluationID=<%=evaluation.getEvaluaionID()%>">추천</a>
						<a onclick="return confirm('삭제하시겠습니까?')" href="./deleteAction.jsp?evaluationID=<%=evaluation.getEvaluaionID()%>">삭제</a>
					</div>
				</div>
			</div>
		</div>
...
%>
	...
	<footer class="bg-dark mt-4 p-5 text-center" style="color:#FFFFFF">
		Copyright &copy; 2023 박재연 All Rights Reserved.
	</footer>	
	<!-- 제이쿼리 자바스크립트 추가하기 -->
